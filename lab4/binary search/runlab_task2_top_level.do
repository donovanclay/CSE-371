...
vlog "./basic_D_FF.sv"
vlog "./bs_datapath.sv"
vlog "./bs_controller.sv"
vlog "./counter_controller.sv"
vlog "./counter_datapath.sv"
vlog "./rom.v"
vlog "./top_level_task2.sv"
...
vsim -voptargs="+acc" -t 1ps -lib work top_level_task2_tb -Lf altera_mf_ver


# Source the wave do file
#  - This should be the file that sets up the signal window for
#    the module you are testing.
do wave_task2_top_level
