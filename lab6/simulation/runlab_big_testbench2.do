...
vlog "../laser_manager.sv"
vlog "../laser_top_level.sv"
vlog "../drawing_state_machine.sv"
vlog "../big_testbench2.sv"
...
vsim -voptargs="+acc" -t 1ps -lib work big_testbench2_tb -Lf altera_mf_ver


# Source the wave do file
#  - This should be the file that sets up the signal window for
#    the module you are testing.
do wave_big_testbench2
